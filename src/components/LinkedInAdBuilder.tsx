...
import { Plus, Edit, Copy, BarChart3, DollarSign, MousePointer, Users, ArrowLeft, Trash2 } from "lucide-react";
...
export function LinkedInAdBuilder() {
  ...
  const { campaigns, isLoading, deleteCampaign, refetch } = useLinkedInCampaigns();
  ...
  if (showCampaignFlow) {
    return (
      <div className="flex flex-col">
        ...
        <LinkedInAdCampaignFlow key={selectedDraftId || 'new'} draftId={selectedDraftId} />
      </div>
    );
  }
