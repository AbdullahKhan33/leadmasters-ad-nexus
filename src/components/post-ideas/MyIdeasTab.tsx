...
export const MyIdeasTab = () => {
  ...
  return (
    <div className="w-full flex justify-center px-4">
      ...
      {/* Action Buttons - Fixed floating at bottom */}
      {selectedIds.length > 0 && (
        <div className="fixed bottom-4 left-0 right-0 z-40 flex justify-center px-4 pointer-events-none ml-64">
          <div className="w-full max-w-6xl">
            <div className="bg-background border border-border p-4 rounded-xl shadow-xl flex items-center justify-between gap-4 pointer-events-auto">
              <p className="text-sm font-medium">
