  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-gray-600">Create and manage your Facebook advertising campaigns</p>
      </div>
      ...
      <Card className="border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
        <CardContent className="p-8 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-600 mb-6">Start building your next Facebook ad campaign with our AI-powered tools</p>
            <Button 
              size="lg" 
              className="bg-purple-600 hover:bg-purple-700 text-white transition-all duration-200 shadow-lg hover:shadow-xl px-8"
            >
