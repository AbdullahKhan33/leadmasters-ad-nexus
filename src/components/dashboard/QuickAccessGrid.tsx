  ...
  const quickAccessCards = [
    {
      ...
      onClick: () => navigate("/app", { state: { view: "crm" }, replace: true }),
    },
    {
      ...
      onClick: () => navigate("/app/campaigns/create", { replace: true }),
    },
    {
      title: "WhatsApp Hub",
      ...
      onClick: () => navigate("/app", { state: { view: "ad-builder", platform: "whatsapp" }, replace: true }),
    },
    {
      ...
      icon: Calendar,
      stat: "View calendar",
      onClick: () => navigate("/app", { state: { view: "schedule" }, replace: true }),
    },
    {
      ...
      onClick: () => navigate("/app", { state: { view: "published-posts" }, replace: true }),
    },
    {
      title: "Analytics",
      ...
      onClick: () => navigate("/app", { state: { view: "analytics" }, replace: true }),
    },
  ];
