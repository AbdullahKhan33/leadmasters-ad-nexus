...
export function InstagramCampaignSetupStep({ data, onUpdate, onNext, onSaveDraft }: InstagramCampaignSetupStepProps) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.adAccount} onValueChange={(value) => handleChange("adAccount", value)}>
              ...
              <SelectContent>
                <SelectItem value="account1">LeadMasters Instagram Account</SelectItem>
                <SelectItem value="account2">Business Instagram Account</SelectItem>
                <SelectItem value="account3">Marketing Instagram Account</SelectItem>
              </SelectContent>
            </Select>
          </div>
