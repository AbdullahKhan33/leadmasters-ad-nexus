    ...
    <div className="flex-1 min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50/30 to-sky-50/20 overflow-y-auto">
      <div className="max-w-5xl mx-auto p-8 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-[#1DA1F2] via-[#0084B4] to-[#00ACED] bg-clip-text text-transparent">
        ...
        {(isGenerating || showResponse) && (
          <div className="space-y-6">
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Generated Tweet</h2>
              <p className="text-gray-600">AI-powered content ready for your Twitter account</p>
            </div>
              ...
              <Card className="max-w-2xl mx-auto bg-white/60 backdrop-blur-xl border border-white/30 shadow-xl">
                <CardContent className="flex flex-col items-center justify-center py-12">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <span className="text-lg font-medium text-gray-700">Generating tweet...</span>
                  </div>
              ...
              <Card className="max-w-2xl mx-auto relative overflow-hidden bg-white/90 backdrop-blur-xl border border-white/40 shadow-2xl shadow-blue-500/10 animate-in fade-in duration-700 slide-in-from-bottom-8">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
                    <Button className="group relative h-12 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105">
