...
import { Plus, Edit, Copy, BarChart3, DollarSign, MousePointer, Eye } from "lucide-react";
  ...
  return (
    <div className="flex-1 p-6 bg-gray-50">
      <div className="max-w-7xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-[#7C3AED] to-[#D946EF] bg-clip-text text-transparent mb-2">Google Ad Builder</h1>
